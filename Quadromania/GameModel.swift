...
class GameModel {
    ...
    /// Allow deallocation from any actor context.
    /// Without this, SWIFT_DEFAULT_ACTOR_ISOLATION=MainActor would make the
    /// deinit hop to the main executor, which crashes under XCTest's memory checker.
    nonisolated deinit {}
